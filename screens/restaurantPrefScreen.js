        ...
        <View style={styles.container}>
            ...
            <ScrollView>
                ...
                <View style={styles.buttons}>
                    <OurButton style={styles.button} text='Gourmet' onPress={() => checkPrefCuisine('Gourmet')} />
                    <OurButton style={styles.button} text='Frachouillarde' onPress={() => checkPrefCuisine('Frachouillarde')} />
                    <OurButton style={styles.button} text='Bistronomie' onPress={() => checkPrefCuisine('Bistronomie')} />
                    <OurButton style={styles.button} text='Café cosy' onPress={() => checkPrefCuisine('Café cosy')} />
                    <OurButton style={styles.button} text='Petite Bourse' onPress={() => checkPrefCuisine('Petite Bourse')} />
                </View>
                <Title style={styles.titre}
                    h5={true}>L'atmosphère du lieu</Title>
                <View style={styles.buttons}>
                    <OurButton style={styles.button} text="Groupe d'amis" onPress={() => checkPrefAtmos("Groupe d'amis")} />
                    <OurButton style={styles.button} text='Famille' onPress={() => checkPrefAtmos('Famille')} />
                    <OurButton style={styles.button} text='Tête à tête' onPress={() => checkPrefAtmos('Tête à tête')} />
                </View>
                ...
                <View style={styles.buttons}>
                    <OurButton text='Accueil PMR' onPress={() => checkPreMesce('Accueil PMR')} />
                    <OurButton text='Animaux acceptés' onPress={() => checkPreMesce('Animaux acceptés')} />
                </View>
                <Title style={styles.titre}
